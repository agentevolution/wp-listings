        ...
        <div id="post-body">
            <div id="post-body-content" class="has-sidebar-content">
				...
				<form action="options.php" method="post" id="wp-listings-stylesheet-options-form">
					...
					<?php echo '<h4><input name="wp_listings_stylesheet_load" id="wp_listings_stylesheet_load" type="checkbox" value="1" class="code" ' . checked(1, get_option('wp_listings_stylesheet_load'), false ) . ' /> Deregister WP Listings CSS?</h4>'; ?>
					<?php
				    ...
				    echo '<h4>Default State:<input name="wp_listings_default_state" id="wp_listings_default_state" type="text" value="' . get_option('wp_listings_default_state') . '" size="1" /></h4>';
					?>
					<br />
