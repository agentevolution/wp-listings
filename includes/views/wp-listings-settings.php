	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
        ...
        <div id="post-body">
            <div id="post-body-content" class="has-sidebar-content">
				...
				if (get_option('wp_listings_widgets_stylesheet_load') == 1)
				...
				<form action="options.php" method="post" id="wp-listings-stylesheet-options-form">
					...
					<?php echo '<h4><input name="wp_listings_stylesheet_load" id="wp_listings_stylesheet_load" type="checkbox" value="1" class="code" ' . checked(1, get_option('wp_listings_stylesheet_load'), false ) . ' /> Deregister WP Listings main CSS (wp-listings.css)?</h4>'; ?>

					<?php echo '<h4><input name="wp_listings_widgets_stylesheet_load" id="wp_listings_widgets_stylesheet_load" type="checkbox" value="1" class="code" ' . checked(1, get_option('wp_listings_widgets_stylesheet_load'), false ) . ' /> Deregister WP Listings widgets CSS (wp-listings-widgets.css)?</h4><hr>'; ?>
