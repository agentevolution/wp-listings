		...
		<div id="post-body">
			<div id="post-body-content" class="has-sidebar-content">
				...
				<form action="options.php" method="post" id="wp-listings-settings-options-form">
					...
					_e("<h3>Default Currency</h3><p>Select a default currency symbol and optional currency code to display on listings.</p>", 'wp_listings' );
					...
					_e("<h3>Default Disclaimer</h3><p>Optionally enter a disclaimer to show on single listings. This can be overridden on individual listings.</p>", 'wp_listings' );
					...
					if(class_exists( 'Idx_Broker_Plugin' )) {
						_e("<hr style=\"margin: 25px 0;\"><h3>IDX Imported Listings</h3><p>These settings apply to any imported IDX listings. Imported listings are updated via the latest API response twice daily.</p>", 'wp_listings' );
