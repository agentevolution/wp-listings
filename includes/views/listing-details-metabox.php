...
echo '<div style="width: 90%; float: left;">';
	...
	_e('<p><label>Photo Gallery Shortcode:<br />', 'wp_listings');
	printf( __( '<textarea name="wp_listings[_listing_photos]" rows="1" cols="18" style="%s">%s</textarea></label></p>', 'wp_listings' ), 'width: 99%;', htmlentities( get_post_meta( $post->ID, '_listing_photos', true) ) );
